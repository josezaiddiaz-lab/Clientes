...
def reorganizar_con_meses_en_sheet(df_actual, tipo_seccion):
    ...
    for reg in registros:
        ...
        if dt:
            if dt.month != mes_actual:
                ...
                if tipo_seccion == "Abono a tarjeta de crédito":
                    ...
                    saldo_tc_acumulado = t_debito_actual  # Inicializa con la tarjeta de débito
        ...
        # Calcular lógica de abono y sustitución de tarjeta de débito / saldo tc
        if tipo_seccion == "Abono a tarjeta de crédito":
