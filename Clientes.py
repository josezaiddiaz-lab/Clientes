...
def recalcular_y_sincronizar_tarjeta_tc():
    try:
        load_data.clear()  # Limpia caché para evitar datos desactualizados o duplicados
...
# CORRECCIÓN SEGURA PARA EVITAR ERROR DE WORKSHEET EXISTENTE
try:
...
if pestana_seleccionada == "Utilidad":
    ...
    # --- MODIFICACIÓN PARA RESALTAR FILAS "PENDIENTE" ---
