...
def reorganizar_con_meses_en_sheet(df_actual, tipo_seccion):
    ...
    for _, row in df_actual.iterrows():
        ...
        if identificador and not identificador.startswith("---") and not identificador.startswith("TOTALES") and not identificador.startswith("El mes"):
            r_dict = row.to_dict()
        ...
        if df.empty:
            ...
            for idx, row in df.iterrows():
                if pestana_seleccionada == "Abono a tarjeta de crédito":
                    ...
                    if val_id and not val_id.startswith("---") and not val_id.startswith("TOTALES") and not val_id.startswith("El mes"):
