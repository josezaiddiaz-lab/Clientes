...
# NOTA: Al usar clear_on_submit=True, es mejor remover las 'keys' fijas 
# de los inputs del formulario para evitar conflictos de estado en Streamlit.
with st.sidebar.form("alta_form", clear_on_submit=True):
    ...
    iva_input = st.text_input("IVA (Opcional, por defecto 16%)", value="")
    isr_input = st.text_input("ISR (Opcional, por defecto 1.25%)", value="")
