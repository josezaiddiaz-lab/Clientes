...
# Control de la sección seleccionada en el estado para evitar bloqueos al refrescar
if "seccion_activa" not in st.session_state:
    st.session_state.seccion_activa = "Clientes"

# Sincronización automática del saldo al cargar la aplicación o cambiar de sección
...
with col_metrica:
    ...
    # Botón para refrescar saldo: limpia caché, recalcula y redirige limpiamente a la sección Clientes
...
# Menú lateral conectado al estado para evitar desincronizaciones
...
# Manejo seguro para obtener o crear la pestaña sin causar APIError si ya existe
try:
