...
with st.sidebar.form("alta_form"):
    ...
    # Cálculo automático dinámico en base al subtotal ingresado
...
with st.expander("✏️ Editar o Eliminar Registros"):
    if df.empty:
        ...
        if seleccion == "-- Selecciona un registro --":
            ...
            # Cálculo automático en tiempo real para edición
            ...
            # Función callback para limpiar el selectbox de forma segura antes de recargar
