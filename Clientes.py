        ...
        if seleccion == "-- Selecciona un registro --":
            ...
            if actualizar:
                ...
                if e_factura.strip() in facturas_existentes:
                    ...
                    # Solución: Actualizar el estado antes de llamar a st.rerun() y evitar modificarlo después del selectbox
                    st.session_state.select_edit = "-- Selecciona un registro --"
            ...
            if eliminar:
                ...
                # Solución: Actualizar el estado antes de llamar a st.rerun()
                st.session_state.select_edit = "-- Selecciona un registro --"
