...
with st.expander("✏️ Editar o Eliminar Registros"):
    if df.empty:
        ...
        if seleccion == "-- Selecciona un registro --":
            ...
            # Quitamos el st.form para permitir actualización inmediata en tiempo real al cambiar el selectbox
            ...
            e_iva_input = st.text_input("IVA", value=e_iva_val, key="e_iva")
            e_isr_input = st.text_input("ISR", value=e_isr_val, key="e_isr")
