...
def generar_pdf(df, titulo_reporte):
    ...
    if df.empty:
        ...
        # Calcular anchos dinámicos para evitar que se salgan de las celdas
...
if pestana_seleccionada == "Utilidad":
    ...
    # Botón de Descarga PDF para Utilidad
    ...
    # Botón de Descarga PDF para Clientes, Proveedores y Gastos
    ...
    # --- SECCIÓN ORIGINAL DE EDITAR O ELIMINAR REGISTROS ---
    st.markdown("---")
            ...
            if seleccion == "-- Selecciona un registro --":
                ...
                with st.form("form_editar_factura"):
                    ...
                    if eliminar:
                        ...
                        temp_df = pd.DataFrame(current_records)
                        reorganized = reorganizar_con_meses_en_sheet(temp_df, pestana_stylesheet if 'pestana_stylesheet' in locals() else temp_df) # safety fallback
