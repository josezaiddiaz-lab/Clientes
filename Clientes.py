...
# Bandera auxiliar para limpiar el selectbox antes de renderizarlo sin violar reglas de Streamlit
        ...
        if seleccion == "-- Selecciona un registro --":
            ...
            if actualizar:
                ...
                if e_factura.strip() in facturas_existentes:
                    ...
                    # Activamos la bandera de reinicio para la siguiente ejecución antes de hacer rerun
