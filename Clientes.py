...
def reorganizar_con_meses_en_sheet(df_actual, tipo_seccion):
    ...
    for _, row in df_actual.iterrows():
        ...
        if tipo_seccion == "Abono a tarjeta de crédito":
            # Evita que cualquier rastro de filas falsas o pruebas previas contamine el reporte
    ...
    if not registros and tipo_seccion == "Abono a tarjeta de crédito":
        # Si no hay registros, devolvemos una lista vacía limpia para no forzar filas de prueba en Google Sheets
        return []
